# 파일 경로: sejong_university/publickey_cryptography/gui/rsa_gui.py

import tkinter as tk
from tkinter import ttk, messagebox, scrolledtext
# crypto_pkg 폴더에 있는 rsa.py를 임포트합니다.
from crypto_pkg.rsa import generate_rsa_keys, rsa_encrypt, rsa_decrypt
